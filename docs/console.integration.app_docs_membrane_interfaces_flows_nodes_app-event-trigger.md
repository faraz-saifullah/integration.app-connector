---
url: "https://console.integration.app/docs/membrane/interfaces/flows/nodes/app-event-trigger"
...
Before creating App Event trigger, you need to create an [App Event](https://console.integration.app/docs/membrane/interfaces/internal-events). Whenever you trigger that app event, the flow will be launched.
...
- [Filter](https://console.integration.app/docs/membrane/interfaces/flows/nodes/app-event-trigger#filter)
- [See Also](https://console.integration.app/docs/membrane/interfaces/flows/nodes/app-event-trigger#see-also)
