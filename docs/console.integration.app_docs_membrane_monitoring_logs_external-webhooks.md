---
url: "https://console.integration.app/docs/membrane/monitoring/logs/external-webhooks"
...
When integration engine receives an external webhook, we record the payload and any events extracted from it.

You can find the logs here: [External Webhooks](https://console.integration.app/w/0/activity/external-webhook-logs)
