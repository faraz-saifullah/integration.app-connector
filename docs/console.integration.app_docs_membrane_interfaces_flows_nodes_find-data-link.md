---
url: "https://console.integration.app/docs/membrane/interfaces/flows/nodes/find-data-link"
...
This node finds uses a [Data Link](https://console.integration.app/docs/membrane/interfaces/data-links) between an object in your app and an object in an external app
to find the matching object on the opposite side.

It should be used together with [Create Data Link](https://console.integration.app/docs/membrane/interfaces/flows/nodes/create-data-link)

The node outputs the ID of the matching records if one found, otherwise its output is empty.
...
- [See Also](https://console.integration.app/docs/membrane/interfaces/flows/nodes/find-data-link#see-also)
